...
class AddEditStudentActivity : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_ID: String =
            "com.sweak.teacherhelper.ui.activity.AddEditStudentActivity.EXTRA_ID"
        const val EXTRA_FIRST_NAME: String =
            "com.sweak.teacherhelper.ui.activity.AddEditStudentActivity.EXTRA_FIRST_NAME"
        const val EXTRA_LAST_NAME: String =
            "com.sweak.teacherhelper.ui.activity.AddEditStudentActivity.EXTRA_LAST_NAME"
        const val EXTRA_CLASS_NAME: String =
            "com.sweak.teacherhelper.ui.activity.AddEditStudentActivity.EXTRA_CLASS_NAME"
        const val EXTRA_GROUP_ID: String =
            "com.sweak.teacherhelper.ui.activity.AddEditStudentActivity.EXTRA_GROUP_ID"
    }
}